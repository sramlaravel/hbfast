...
Route::group(['namespace' => 'admin','prefix' => 'admin','middleware'=>'auth:admin'], function () {
    ...
    Route::group(['prefix' => 'banks'], function () {
        Route::get('/','BanksController@index') -> name('admin.banks');
        Route::get('create','BanksController@create') -> name('admin.banks.create');

        Route::post('store','BanksController@store') -> name('admin.banks.store');
        Route::get('edit/{id}','BanksController@edit') -> name('admin.banks.edit');
        Route::post('update/{id}','BanksController@update') -> name('admin.banks.update');
        Route::get('delete/{id}','BanksController@destroy') -> name('admin.banks.delete');
    ...
    Route::group(['prefix' => 'local'], function () {
        Route::get('/','PartnersLocalController@index') -> name('admin.localparnters');
        Route::get('create','PartnersLocalController@create') -> name('admin.localparnters.create');

        Route::post('store','PartnersLocalController@store') -> name('admin.localparnters.store');
        Route::get('edit/{id}','PartnersLocalController@edit') -> name('admin.localparnters.edit');
        Route::post('update/{id}','PartnersLocalController@update') -> name('admin.localparnters.update');

        Route::get('delete/{id}','PartnersLocalController@destroy') -> name('admin.localparnters.delete');
        Route::get('changeStatus/{id}','PartnersLocalController@changeStatus') -> name('admin.localparnters.status');
