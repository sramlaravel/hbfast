                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة بنك جديد </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.banks.store' )}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section">
                                                    <i class="ft-home"></i> بيانات البنك </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اسم البنك </label>
                                                            <input type="text" value=" {{Request::old('name')}}" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   name="name">
                                                            @error("name")
                                                    ...
                                                    {{--<div class="col-md-12">--}}
                                                        ...
                                                        {{--<div class="form-group">--}}
                                                            ...
                                                            {{--<textarea class="form-control" id="placeTextarea" rows="3"--}}
                                                                      ...
                                                                      {{--placeholder="ادخل الوصف."> {{Request::old('news_desc')}} </textarea>--}}
                                                            {{--@error('news_desc')--}}
                                                            {{--<span class="text-danger">{{$message}} </span>--}}
                                                            {{--@enderror--}}
                                                        {{--</div>--}}
