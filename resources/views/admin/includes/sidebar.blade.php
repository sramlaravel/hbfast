    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">البنوك  </span>
                    <span
                            class="badge badge badge-warning  badge-pill float-right mr-2">{{App\Models\Banks::count()}} </span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.banks')}} "
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.banks.create')}}" data-i18n="nav.dash.crypto">أضافة  بنك جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الوكالات المحلية  </span>
                    <span  class="badge badge badge-success badge-pill float-right mr-2">{{App\Models\Partners::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.localparnters')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.localparnters.create')}}" data-i18n="nav.dash.crypto">أضافة وكالات جديده </a>
                    </li>
                </ul>
            </li>
