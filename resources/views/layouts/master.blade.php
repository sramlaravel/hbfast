...
<div class="woodmart-social-icons text-center icons-design-colored icons-size-custom color-scheme-dark social-follow social-form-square woodmart-sticky-social woodmart-sticky-social-left buttons-loaded"> <a rel="nofollow" href="https://api.whatsapp.com/send?phone=966583114139" target="_blank" class="whatsapp-desktop  woodmart-social-icon social-whatsapp"> <i class="fa fa-whatsapp"></i> <span class="woodmart-social-icon-name">WhatsApp</span> </a> <a rel="nofollow" href="https://api.whatsapp.com/send?phone=966583114139" target="_blank" class="whatsapp-mobile  woodmart-social-icon social-whatsapp"> <i class="fa fa-whatsapp"></i> <span class="woodmart-social-icon-name">WhatsApp</span> </a></div>
{{--<div id="searchbox">--}}
...
<div class="fb-customerchat" attribution="install_email"></div>
<!-- Load Facebook SDK for JavaScript -->
<div id="fb-root">
    <script src="https://connect.facebook.net/en_US/sdk/xfbml.customerchat.js" type="text/javascript"></script>
    {{--<script src="https://connect.facebook.net/en_US/sdk/xfbml.customerchat.js {{asset('js/xfbml.customerchat.js') }}" type="text/javascript"></script>--}}
</div>

<!-- Your customer chat code -->
<div class="fb-customerchat"  attribution="setup_tool"   page_id="595172807221863"  theme_color="#79000e"logged_in_greeting="مرحبا ، أرسل لللإستفسار وسنجيبك في أقرب وقت"
