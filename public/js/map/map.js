        ...
        $.ajax({
            ...
            success: function (msg) {
                for (i = 0; i < msg.length; i++) {
                    var obj = [];
                    //console.log(msg[i]);
                    obj[0] = '<img src="/theme/standard/images/branch-img1.jpg" alt="branch"/>';
                    obj[1] = msg[i]['location_name'];
                    obj[2] = msg[i]['address'];
                    obj[3] = msg[i]['phone'];
                    obj[4] = msg[i]['phone2'];
                ...
                for (i = 0; i < locations.length; i++) {
                    ...
                    google.maps.event.addListener(marker, 'click', (function (marker, i) {
                        return function () {
                            var box_contnet;
                            box_contnet = '<div class="clearfix" id="infobox">';
...
//                            infobox.setContent('<div class="clearfix" id="infobox">'+ locations[i][0] + '</div>');
                            ...
                            map.setZoom(parseInt(locations[i][8]));
